...
def click_continuous(coordinates, interval_time):
    try:
        while True:
            for coord in coordinates:
                pyautogui.click(coord[0])  # Click at the specified coordinates
                time.sleep(1)
                pyautogui.click(coord[1])  # Click at the specified coordinates
...
def main():
    ...
    click_continuous(coordinates, modified_interval)
